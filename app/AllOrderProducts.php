...
class AllOrderProducts extends Model {
    ...
    protected $fillable = ['order_id', 'order_type', 'from', 'product_category_id', 'unit_id', 'quantity', 'actual_pieces', 'price', 'vat_percentage', 'present_shipping', 'remarks', 'parent', 'actual_quantity'];
