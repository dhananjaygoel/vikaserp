...
//        }
        ...
        return view('dashboard', compact('order', 'pending_order', 'order_pending_sum', 'inquiry', 'pending_inquiry', 'inquiry_pending_sum', 'deliver_sum', 'deliver_pending_sum', 'delivery_challan_sum', 'purc_order_sum', 'inquiries_stats_all','orders_stats_all','delivery_challan_stats_all'));
    }
