            ...
            if ($delivery_order_info->order_status == 'pending') {
                ...
                foreach ($delivery_order_info->delivery_product as $delivery_order_productinfo) {
                    if ($delivery_order_productinfo->unit_id == 1){
                        $deliver_pending += $delivery_order_productinfo->present_shipping;
                        ...
                        $deliver_pending += $delivery_order_productinfo->present_shipping * $delivery_order_productinfo->product_sub_category->weight * ($delivery_order_productinfo->length/305);
                    }
