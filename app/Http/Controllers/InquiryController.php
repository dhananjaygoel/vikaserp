        ...
        if (Auth::user()->role_id <> 5) {
            ...
            if ((isset($data['inquiry_filter'])) && $data['inquiry_filter'] != '') {
                ...
                if ($data['inquiry_filter'] == 'Approval') {
                    ...
                    $inquiries = Inquiry::where('inquiry_status', '=', $data['inquiry_filter'])->with('customer', 'product_sub_category','delivery_location', 'inquiry_products.inquiry_product_details', 'createdby')->orderBy('created_at', 'desc')->where('is_approved', '=', 'yes')->Paginate(20);
