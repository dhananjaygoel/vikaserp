...
<head>
	...
	<title>Edit Customer Manager - Vikas Associate Order Automation System</title>
        ...
        <div class="main-box">
            ...
            <div class="main-box-body clearfix">
                ...
                <div class="form-group">
                    ...
                    <input id="number" class="form-control" placeholder="Number" name="number" value="" type="text">
                </div>  
                ...
                <div >
                    ...
                    <a href="customermanager.php" class="btn btn-default form_button_footer">Back</a>
                </div>
