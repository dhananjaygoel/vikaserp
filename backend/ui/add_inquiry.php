...
<head>
	...
	<title>Add Inquiry - Vikas Associate Order Automation System</title>
    ...
    <div class="col-lg-12">
        <div class="main-box">
            <header class="main-box-header clearfix">
                <h2><i class="fa fa-dashboard"></i> &nbsp; Add Inquiry</h2>
            </header>            
    ...
    <option id="other" value="3">Other</option>
			...
			<label for="inquiry_remark">Remark</label>
                ...
                <div >
                    ...
                    <a href="enquiry.php" class="btn btn-default form_button_footer">Back</a>
                </div>
