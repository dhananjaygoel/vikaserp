                ...
                <form method="POST" action="" accept-charset="UTF-8" >
                    <div class="form-group ">
                            <div class="radio superadmin">
                                 <input checked="" value="superadmin" id="optionsRadios7" name="status" type="radio">
                        <label for="optionsRadios7">Viewable to Admin and Superadmin</label>
                               <input  value="viewall" id="optionsRadios8" name="status" type="radio">
                        <label for="optionsRadios8">Viewable by all</label>
