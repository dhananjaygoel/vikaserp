...
<head>
	...
	<title>Add IP Address - Vikas Associate Order Automation System</title>
							...
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										...
										<li class="active"><span>Add IP Address</span></li>
									</ol>
        ...
        <div class="main-box">
            ...
            <div class="main-box-body clearfix">
                ...
                <div class="form-group">
                    ...
                    <input id="ip" class="form-control" placeholder="IP Address" name="ip" value="" type="text">
                </div>                                                    
