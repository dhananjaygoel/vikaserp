...
<head>
	...
	<title>Add Product Category - Vikas Associate Order Automation System</title>
    ...
    <div class="col-lg-12">
        <div class="main-box">
            <header class="main-box-header clearfix">
                <h2><i class="fa fa-user"></i> &nbsp; Add Product Category</h2>
            </header>            
            ...
            <div class="main-box-body clearfix">
                ...
                <div class="form-group">
                    ...
                    <input id="cat_name" class="form-control" placeholder="Sub Product Category Name" name="cat_name" value="" type="text">
                </div>
