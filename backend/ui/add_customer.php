...
<head>
	...
	<title>Add Customer - Vikas Associate Order Automation System</title>
    ...
    <div class="col-lg-12">
        <div class="main-box">
            <header class="main-box-header clearfix">
                <h2><i class="fa fa-user"></i> &nbsp; Add Customer</h2>
            </header>            
            ...
            <div class="main-box-body clearfix">
                ...
                <div class="clearfix"></div>
					...
					<?php include("include/footer.php"); ?><footer id="footer-bar" class="row">
