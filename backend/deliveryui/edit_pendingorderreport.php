...
<head>
	...
	<title>Edit Pending Orders - Vikas Associate Order Automation System</title>
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Edit Pending Order</span></li>
									</ol>
    ...
    <div class="col-lg-12">
        <div class="main-box">
            <header class="main-box-header clearfix">
                <h2><i class="fa fa-dashboard"></i> &nbsp; Edit Pending Order </h2>
            </header>            
    ...
    <option id="other" value="3">Other</option>
			...
			<label for="inquiry_remark">Remark</label>
                ...
                <div >
                    ...
                    <a href="pending_orders.php" class="btn btn-default form_button_footer">Back</a>
                </div>
