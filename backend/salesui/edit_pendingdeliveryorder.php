...
<head>
	...
	<title>Edit Pending Delivery Order - Vikas Associate Order Automation System</title>
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="sidebar-nav">	
								<ul class="nav nav-pills nav-stacked">
										...
										<ul class="submenu">
											...
											<li>
												<a href="purchaseorder_advise.php" class="active">
													Purchase Advice
												</a>
											</li>
                                                                                        <li>
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Edit Pending Delivery Order</span></li>
									</ol>
    ...
    <div class="col-lg-12">
        <div class="main-box">
            <header class="main-box-header clearfix">
                <h2><i class="fa fa-user"></i> &nbsp; Edit Pending Delivery Order</h2>
            </header>            
            ...
            <div class="main-box-body clearfix">
                ...
                <div class="form-group">
                    <label for="serial"><b>Serial Number:</b> May03/05/02/01</label>
                </div> 
                    <div class="form-group">
