...
<head>
	...
	<title>Edit Pending Purchase Advice - Vikas Associate Order Automation System</title>
											...
											<li>
												<a href="purchaseorder_report.php">
													Purchase Order Report
                                                                                        ...
                                                                                        <li>
												<a href="purchaseorder_advisereport.php" class="active">
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Edit Pending Purchase Advice</span></li>
									</ol>
    ...
    <div class="col-lg-12">
        <div class="main-box">
            <header class="main-box-header clearfix">
                <h2><i class="fa fa-user"></i> &nbsp; Edit Pending Purchase Advice</h2>
            </header>            
            ...
            <div class="main-box-body clearfix">
                ...
                <form method="POST" action="" accept-charset="UTF-8" >
                    ...
                    <div class="form-group">
                        <label for="date"><b>Date:</b> 30 April 2015</label>
                
                </div>
               
                    
                <div class="form-group">
                    <label for="serial"><b>Serial Number:</b>PO/May03/05/02/01</label>
                </div> 
                    <div class="form-group">
                    <label for="truck"><b>Truck Number:</b> MH15/BS/3020</label>
                </div>
                       <div class="form-group ">
                   <div class="col-md-4 purchase_product">
                    ...
                    <br>
                      <div class="form-group">
                        <div class="col-md-4">
                            <label for="serial"><span class="underline serial"><b>Product Name</b></span></label>
                      
                        </div>
                         <div class="col-md-4">
                             <label for="serial"><span class="underline"><b>Present Shipping</b></span></label>
                        </div>
                </div>
                    <div class="clearfix"></div>
                 <div class="form-group delivery_product">
                   <div class="purchase_product col-md-4">
