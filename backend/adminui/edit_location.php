...
<head>
	...
	<title>Edit Location - Vikas Associate Order Automation System</title>
        ...
        <div class="main-box">
            ...
            <div class="main-box-body clearfix">
               ...
               <form method="POST" action="" accept-charset="UTF-8" >
                    ...
                    <div class="form-group">
                    <label for="status">City Name</label>
                ...
                <div >
                    ...
                    <a href="location.php" class="btn btn-default form_button_footer">Back</a>
                </div>
