						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Total Delivery Order</span></li>
									</ol>
									
										<div class="filter-block">
                                                                                    <h1 class="pull-left">View Order</h1>                                 
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody>                    
                                        ...
                                        <tr>
                                            ...
                                            <td><span>Contact Person: </span>Lorem Ipsum Dollar</td>
                                        ...
                                        <tr>
                                            <td class="col-md-4"><span>Category:</span> Pipe</td>
                                            <td><span>Sub-category:</span> Lorem </td>
                                            <td><span>Product:</span> Product1</td>
                                            <td><span>Quantity:</span> 55</td>
                                            <td><span>Unit:</span> 6</td>
                                        </tr>
                                       
                                        <tr>
                                            <td><span>Delivery Location:</span> Location1</td>
                                    
                                        </tr>
                                        <tr>
                                            <td><span>Total Price:</span> 6546</td>
                                    
                                        </tr>
                                       
                                        <tr>
                                            <td><span>Estimated Delivery Time:</span> </td>
