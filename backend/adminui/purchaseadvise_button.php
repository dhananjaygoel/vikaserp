        ...
        <div class="main-box">
            ...
            <div class="main-box-body clearfix">
                ...
                <form method="POST" action="" accept-charset="UTF-8" >
                    ...
                    <input id="date" class="form-control" placeholder="Date" name="date" value="" type="text">
                </div>
               
                    
                <div class="form-group">
                    <label for="serial">Serial Number</label>
                    <input id="serial" class="form-control" placeholder="Serial Number" name="serial" value="" type="text">
                </div>
                    <div class="form-group">
                        <div class="col-md-4">
               ...
               <div class="form-group delivery_product">
                ...
                <div class="clearfix"></div>
                <div class="row delivery_product plus1">
                    <div class="col-md-12">
               ...
               <div class="form-group delivery_product add1" >
                   <div class="purchase_product col-md-4">
                 ...
                 <div class="clearfix"></div>
                  <div class="row delivery_product plus2">
                    <div class="col-md-12">
                 ...
                 <div class="clearfix"></div>
                  <div class="form-group delivery_product add2" >
                   <div class="purchase_product col-md-4">
