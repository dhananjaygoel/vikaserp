...
<head>
	...
	<title>Delivery Orders challan - Vikas Associate Order Automation System</title>
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody>                    
                                        ...
                                        <td class="text-center">
                                           <a href="view_deliverychallan.php" class="table-link" title="view">
                                                <span class="fa-stack">
                                            ...
                                            <a href="edit_deliverychallan.php" class="table-link" title="edit">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
