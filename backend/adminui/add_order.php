        ...
        <div class="main-box">
            ...
            <div class="main-box-body clearfix">
                ...
                <form method="POST" action="" accept-charset="UTF-8" >
                    ...
                    <div class="radio">
                        <input checked="" value="new" id="optionsRadios3" name="status" type="radio">
                        <label for="optionsRadios3">Warehouse</label>
                        <input  value="exist" id="optionsRadios4" name="status" type="radio">
    ...
    <option id="other" value="3">Other</option>
			...
			<label for="inquiry_remark">Remark</label>
                ...
                <div >
                    ...
                    <a href="orders.php" class="btn btn-default form_button_footer">Back</a>
                </div>
