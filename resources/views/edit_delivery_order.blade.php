                                ...
                                <table id="add_product_table_delivery_order" class="table table-hover">
                                        ...
                                        <td class="col-md-2">
                                           ...
                                           <td class="col-md-1">
                                            ...
                                            <td class="col-md-1">
                                                <div class="form-group">
                                                    <input onblur="change_quantity2({{$i}});" id="quantity_{{$i}}" class="form-control focus_on_enter" placeholder="Qnty" name="product[{{$i}}][quantity]" onkeypress=" return numbersOnly(this,event,true,true);" value="quantity" type="text" tabindex="4" >
                                                </div>
                                            </td>
                                          </tr>
                                        <?php } else {
