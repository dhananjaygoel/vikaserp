                ...
                <div class="main-box">
                    <div class="main-box-body clearfix">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" name="final_truck_weight" value="{{ $delivery_data->final_truck_weight}}" id="final_truck_weight" class="form-control" name="final_truck_weight" style="width: 10.33%;" maxlength="10" onkeypress=" return numbersOnly(this, event, true, false);" onchange="truck_weight(this);fetch_average_quantity();">
                            ...
                            @else
                            <input type="text" name="final_truck_weight" value="{{isset($delivery_data->final_truck_weight)?$delivery_data->final_truck_weight:'0'}}" id="final_truck_weight" class="form-control" name="final_truck_weight" style="width: 10.33%;" maxlength="10" onkeypress=" return numbersOnly(this, event, true, false);" onchange="truck_weight(this);fetch_average_quantity();">
                            @endif
                            @else
                            <input type="text" name="final_truck_weight" value="" id="final_truck_weight" class="form-control" name="final_truck_weight" style="width: 10.33%;" maxlength="10" onkeypress=" return numbersOnly(this, event, true, false);" onchange="truck_weight(this);fetch_average_quantity();">
                            @endif 
                        </div>
                        <hr>
                                ...
                                <table id="add_product_table_delivery_challan" class="table table-hover">
                                    <tbody>
                                        ...
                                        <tr id="add_row_{{$key}}" class="add_product_row" {{($product->present_shipping==0)?'style = display:none':''}}>
                                            ...
                                            <td class="col-md-2">
                                                <div class="form-group"> 
                                                    <input id="actual_pieces_{{$key}}" class="form-control " placeholder="Actual Pieces" name="product[{{$key}}][actual_pieces]" value="{{$product->actual_pieces}}" type="tel" onkeypress=" return numbersOnly(this, event, true, false);" maxlength="10" onchange="fetch_average_quantity_dc();" onclick="clear_actual_qty();" >
                                                </div>
                                            </td>
                                            <td class="col-md-2">
                                                <div class="form-group">
                                                    <input id="average_weight_{{$key}}" class="form-control" placeholder="Average Weight" name="product[{{$key}}][average_weight]" value="{{$product->actual_quantity}}" type="tel" onkeypress=" return numbersOnly(this, event, true, false);" onchange="fetch_average_quantity_dc();" maxlength="10" onclick="clear_actual_qty();">
                                                </div>
                                            </td>
                                            <td class="col-md-1">
                                                <!--                                                <div class="form-group">
