                    ...
                    <div class="main-box-body clearfix">
                        ...
                        <form method="POST" action="{{URL::action('UsersController@store')}}" accept-charset="UTF-8" >
                            ...
                            <div class="form-group">
                                ...
                                <input id="Phone_number" class="form-control" placeholder="Phone number " name="telephone_number" value="{{ old('telephone_number') }}" type="tel"onkeypress=" return numbersOnly(this,event,false,false);" maxlength="10">
                            </div>
