                        ...
                        <form method="POST" action="{{URL::action('UsersController@store')}}" accept-charset="UTF-8" >
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="user_type" id="add_user_type">
                                    ...
                                    <option <?php if(old('user_type') == $role_data->role_id) echo 'selected=""'; ?> value="{{$role_data->role_id}}">{{$role_data->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="Phone_number" class="form-control" placeholder="Phone number " name="telephone_number" value="{{ old('telephone_number') }}" type="tel"onkeypress=" return numbersOnly(this,event,false,false);" maxlength="15">
                            </div>

                            <div class="form-group">
                                <label for="mobile_number">Mobile Number<span class="mandatory">*</span></label>
                                <input id="mobile_number" class="form-control" placeholder="Mobile Number" name="mobile_number" value="{{ old('mobile_number') }}" type="tel" onkeypress=" return numbersOnly(this,event,false,false);" maxlength="15">
                            </div>
                            <div class="form-group">
