                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Edit" href="{{ Url::action('DeliveryLocationController@edit', ['location' => $location_data->id]) }}" class="table-link">
                                                <span class="fa-stack">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                {!! Form::open(array('method'=>'DELETE','url'=>url('location',$location_data->id), 'location'=>'delete_location_form'))!!}
                                                <div class="delete">
