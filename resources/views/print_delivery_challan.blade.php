...
<!--                    <table class="table-responsive detail_table">
                    ...
                    <div class="divTable" style="width: 70%;margin-left: 8%;border-left: 1px solid #ccc; border-right: 1px solid #ccc;">
                        <div class="headRow">
                            <div class="divRow">
                                ...
                                <div class="divCell2"><b>Qty</b></div>
                                <div class="divCell"><b>Amount</b></div>
                                <div class="divCell2"><b>GST</b></div>
                            ...
                            <div class="divRow">
                                ...
                                <div class="divCell2"><b>{{ round($allorder->pipe_qty, 2) + round($allorder->structure_qty, 2) }}</b></div>
                                <div class="divCell"><b>{{ round($allorder->pipe_amount, 2) + round($allorder->structure_amount, 2) }}</b></div>
                                <div class="divCell2"><b>{{ round($gst_percentage, 2) }}</b></div>
                ...
                <div class="total">
                    <div class="">
                        <div class="label" style="width: 51.4%"> &nbsp; Total</div>
                        <div class="value bob"> {{ round($total_price, 2) }} &nbsp;</div>
                        <div class="label " style="width: 51.4%">&nbsp; Loading</div>
                        <div class="value">
<?php
...
?>
                        ...
                        <div class="label" style="width: 51.4%">&nbsp; Freight</div>
                        <div class="value">
                            {{($allorder->freight != "")?round($allorder->freight,2):0}} &nbsp;
                        </div>
                        <div class="label" style="width: 51.4%">&nbsp; Discount</div>
                        <div class="value">
...
<?php $with_total = $total_price + $loading_charge + $allorder->freight + $allorder->discount; ?>
                        ...
                        <div class="label" style="width: 51.4%">&nbsp; GST</div>
                        <div class="value">
<?php
$vat = $final_vat_amount;
...
?>
                        ...
                        <div class="label" style="width: 51.4%">&nbsp; Round Off</div>
                        <div class="value">
<?php
...
?>
                        ...
                        <div class="label" style="border-bottom: 1px solid #ccc; width: 51.4%">&nbsp; GT</div>
