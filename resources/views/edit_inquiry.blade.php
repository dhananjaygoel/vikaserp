                    ...
                    <div class="main-box-body clearfix">
                        <form method="POST" action="{{URL::action('InquiryController@store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <input value="existing_customer" id="existing_customer" name="customer_status" type="radio">
                                    <label for="existing_customer">Existing</label>
                                    <input checked="" value="new_customer" id="new_customer" name="customer_status" type="radio">
