<html>
    ...
    <table>
        ...
        <tr>
            ...
            <td>Rate</td>
            <td>Amount</td>
            <td class="heading2 border3">Debit Amount</td>
        </tr>
        <?php
        foreach ($purchase_orders as $key => $value) {
            ...
            <tr>
                ...
                <td class="heading2"><?= $value['supplier']->owner_name ?></td>
                <td></td>
                <td class="heading2">Purchase</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <tr>
                <td></td>
                <td class="text2"><?= $value['purchase_advice']->vehicle_number ?></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
