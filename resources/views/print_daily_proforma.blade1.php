...
//                    $total_qty = $products->price;
                ...
                <div class="divRow">
                    ...
                    <div class="divCell">{{ isset($obj['challan_loaded_by']) ? count((array)$obj['challan_loaded_by']) : '0' }}</div>
                    <div class="divCell">{{ isset($obj['challan_labours']) ? count((array)$obj['challan_labours']) : '0' }}</div>
