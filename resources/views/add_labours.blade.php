            ...
            <div class="col-lg-12">
                <div class="main-box">
                    <div class="main-box-body clearfix">
                        <form id="" method="POST" action="{{url('labours')}}" accept-charset="UTF-8" >
                            ...
                            <div class="form-group">
                                ...
                                <input id="labour_name" class="form-control" placeholder="Labour Name" name="labour_name" value="{{ Input::old('labour_name')}}" type="text" maxlength="30">
                            </div>
                            
<!--                             
                            <div class="form-group">
                                <label for="location">Location</label>
                                <input id="location" class="form-control" placeholder="Location" name="location" value="{{ Input::old('location')}}" type="text">
                            </div>-->
