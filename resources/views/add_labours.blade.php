                    ...
                    <div class="main-box-body clearfix">
                        <form id="" method="POST" action="{{url('performance/labours')}}" accept-charset="UTF-8" >
                            ...
                            <div class="form-group">
                                ...
                                <input id="labour_name" class="form-control" placeholder="Labour Name" name="labour_name" value="{{ Input::old('labour_name')}}" type="text" maxlength="30" required="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="phone_number" class="form-control" placeholder="Phone number " name="phone_number" value="{{ Input::old('phone_number')}}" type="tel" onkeypress=" return numbersOnly(this,event,false,false);" maxlength="10" required="">
                            </div>
