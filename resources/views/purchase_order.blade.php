    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form class="search_form" style="display: flex;width: 84% !important;" method="GET" action="{{URL::action('PurchaseOrderController@index')}}">
                                                ...
                                                <form method="post" class="delete_purchase_order" >
                                                    ...
                                                    <div class="delete">
                                                        ...
                                                        <div class="pwd">
                                                            ...
                                                            <div class="pwdr"><input class="form-control" id="po_delete" placeholder="" type="password" name="password" id="pwdr" required=""></div>
                                                        </div>
                                                        <div class="clearfix"></div>
