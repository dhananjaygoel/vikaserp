            ...
            <div class="col-lg-12">
                <div class="main-box">
                    <div class="main-box-body clearfix">
                        <form id="onenter_prevent" method="POST" action="{{url('pending_customers/'.$customer->id)}}" accept-charset="UTF-8" >
                            ...
                            <div class="form-group">
                                ...
                                <input id="phone_number1" class="form-control" placeholder="Phone number" name="phone_number1" value="{{$customer->phone_number1}}" type="number">
                            </div>
