                        ...
                        <form id="onenter_prevent"  data-button='btn_add_delivery_order' method="POST" action="{{URL::action('DeliveryOrderController@store')}}" accept-charset="UTF-8" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="customer_select" style="{{(Input::old('customer_status') == "new_customer")?'display: none':'display: block'}}">
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            <input class="form-control focus_on_enter tabindex1" placeholder="Enter Tally Name " type="text" id="existing_customer_name" name="existing_customer_name" tabindex="1"/>
                            ...
                            <div class="exist_field" style="{{(Input::old('customer_status') == "new_customer")?'display: block':'display: none'}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="period" class="form-control" placeholder="Credit Period" name="credit_period" onkeypress=" return numbersOnly(this,event,false,false);" value="{{ old('mobile_number') }}" type="tel">
                                </div>
                            </div>
                            <div class="row col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="location_difference" class="form-control focus_on_enter tabindex3" placeholder="Freight" onkeypress=" return numbersOnly(this,event,true,true);" name="location_difference" value="" type="tel" tabindex="3"/>
                                    </div>
                                </div>
                            </div>
                            <br>
