            ...
            <div class="col-lg-12">
                ...
                <div class="search_form_wrapper orders_search_wrapper col-lg-12" style="width:70%">                        
                    <div class="col-lg-12">
                        ...
                        <form class="pull-left" method="get" action="{{URL::action('OrderController@exportOrderBasedOnStatus1')}}">
                                ...
                                <tbody>
                                    ...
                                    <tr id="order_row_{{$order->id}}">
                                        ...
                                        <td> 
                                            ...
                                            <a href="{{url('orders/'.$order->id)}}" class="/*table-link*/ btn btn-primary btn-sm" title="view">View
    <!--                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-search fa-stack-1x fa-inverse"></i>
                                                </span>-->
