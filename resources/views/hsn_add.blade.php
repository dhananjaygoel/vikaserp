                        ...
                        <div class="main-box-body clearfix">
                            ...
                            <form id="" method="POST" action="{{URL::action('HsnController@store')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="hsn_code" class="form-control" placeholder="HSN Code" name="hsn_code" value="{{ old('hsn_code') }}" type="number" onkeypress=" return numbersOnly(this, event, false, false);">
                                </div>
