            ...
            <div class="col-lg-12">
                ...
                <div class="clearfix">
                    ...
                    <div class="pull-right top-page-ui">
                        ...
                        <div class="search_form_wrapper pull-right" style="width:102% ">
                                                ...
                                                <form method="POST" id="delete_purchase_challan_form">
                                                    ...
                                                    <div class="delete">
                                                        ...
                                                        <div class="pwd">
                                                            ...
                                                            <div class="pwdr"><input class="form-control" id="dc_delete" required="" placeholder="" type="password" name="password"></div>
                                                        </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="checkbox">
                                                    <label style="margin-right:10px;"><input type="checkbox" id="checkwhatsapp" name="send_whatsapp" value="yes"><span title="Whatsapp message would be sent to Relationship Manager" class="checksms smstooltip">Send Whatsapp</span></label>
