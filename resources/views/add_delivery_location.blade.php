                    ...
                    <div class="main-box-body clearfix">
                        ...
                        <form id="" method="POST" action="{{URL::action('DeliveryLocationController@store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="difference" class="form-control" placeholder="Difference" name="difference" value="{{Input::old('difference')}}" type="tel" onkeypress=" return numbersOnly(this,event,true,true);">
                            </div>
                            <hr>
                            <div>
