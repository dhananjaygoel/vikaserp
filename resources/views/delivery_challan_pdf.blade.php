        ...
        <table class="user-invoice-data">
            <thead>
                <tr>
                    ...
                    <td>Pcs</td>
                    <td>Qty</td>
                    @if(isset($allorder['delivery_challan_products'][0]->vat_percentage) && $allorder['delivery_challan_products'][0]->vat_percentage > 0 && $allorder->vat_percentage == 0)
                        @if($local_state == 1)
                            <td>SGST</td>
                            <td>CGST</td>
                        @else
            ...
            @foreach($allorder['delivery_challan_products'] as $prod)
                ...
                <tbody>
                    <tr>
                        ...
                        $gst = 0;
                        $rate = $prod->price;
                        if(isset($prod->vat_percentage) && $prod->vat_percentage > 0 && $allorder->vat_percentage == 0){
