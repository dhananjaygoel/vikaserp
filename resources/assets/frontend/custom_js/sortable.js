...
//            cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this);return false;">' + txt + '<span class="sortarrow">&nbsp;&nbsp;<img src="' + image_path + image_none + '" alt="&darr;" title="&darr;"/></span></a>';
            cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this);return false;">' + txt + '<span class="sortarrow">&nbsp;&nbsp;<img src="" alt="&darr;" title="&darr;"/></span></a>';
        }
    }
    alternate(table);
}
...
//        ARROW = '&nbsp;&nbsp;<img src="' + image_path + image_up + '" alt="&uarr;"/>';
        ARROW = '&nbsp;&nbsp;<img src="" alt="&uarr;"/>';
        newRows.reverse();
        span.setAttribute('sortdir', 'up');
    } else {
//        ARROW = '&nbsp;&nbsp;<img src="' + image_path + image_down + '" alt="&darr;"/>';
        ARROW = '&nbsp;&nbsp;<img src="" alt="&darr;"/>';
...
//                allspans[ci].innerHTML = '&nbsp;&nbsp;<img src="' + image_path + image_none + '" alt="&darr;"/>';
                allspans[ci].innerHTML = '&nbsp;&nbsp;<img src="" alt="&darr;"/>';
            }
        }
    }
