...
//  Route::post('bulk-delete', 'BulkDeleteController@show_result');
    ...
    Route::get('otp_verification', 'DashboardController@generate_otp');
    Route::get('resend_otp', 'DashboardController@resend_otp');
    Route::post('validate_otp', 'DashboardController@validate_otp');
...
//  Route::get('graph-order', 'DashboardController@graph_order_temp');
    ...
    Route::any('set_price/{id}', 'CustomerController@set_price');
    Route::any('update_set_price', 'CustomerController@update_set_price');
    ...
    Route::get('save_product', 'DeliveryOrderController@save_product');
    Route::get('save_empty_truck', 'DeliveryOrderController@save_empty_truck');
    Route::get('save_final_truck', 'DeliveryOrderController@save_final_truck');
    Route::get('save_truck_weight', 'DeliveryOrderController@save_truck_weight');
    Route::get('send_save_truck_msgs', 'DeliveryOrderController@send_save_truck_msg');
    Route::post('loaded_assign', 'OrderController@loaded_assign');
    Route::get('load_notification', 'OrderController@load_notification');
    Route::get('read_notification', 'OrderController@read_notification');
    Route::get('supervisor_count', 'OrderController@supervisor_count');
    ...
    Route::get('pending_delivery_order', 'DeliveryOrderController@pending_delivery_order');
...
//    Route::get('fetch_existing_supplier', 'InquiryController@fetch_existing_supplier');
    ...
    Route::get('purchaseorder_advise_challan/{id}', 'PurchaseAdviseController@purchaseorder_advise_challan');
    ...
    Route::get('create_load_truck/{id}', 'DeliveryOrderController@create_load_truck');
     Route::post('create_load_truck/{id}', 'DeliveryOrderController@store_load_truck');
    ...
    Route::get('daily_pro_forma_invoice', 'SalesDaybookController@daily_pro_forma_invoice');
...
Route::get('get-data', 'DeliveryOrderController@get_data');
    ...
    Route::post('update', 'DBController@update_hsn');
    Route::get('update/hsn', 'DBController@update_hsn_test');
